...
constexpr const char* TEXTURE_FORMAT_STRING[DXGI_FORMAT::DXGI_FORMAT_B4G4R4A4_UNORM + 1]{
    "DXGI_FORMAT_UNKNOWN",
...
constexpr const char* BC_FORMAT_STRING[7] {
    "Pick Best Fit",
    "BC1 (RGBA) Low Quality Alpha",
    "BC3 (RGBA) Medium Quality",
    "BC4 (R8) Single-Channel Grayscale",
    "BC5 (R8G8) Dual-Channel Grayscale",
    "BC6 (UF16) HDR",
    "BC7 (RGBA) High Quality"
};
