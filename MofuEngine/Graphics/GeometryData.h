...
{
	u8 Color[3]{0,0,0};
	u8 TNSign{0}; // bit 0: tangent handedness, bit 1: tangent.z sign, bit 2: normal.z sign (0 for -1, 1 for +1)
	v2 UV{0,0};
	u16 Normal[2]{0,0}; // normal packed as xy, reconstruct with normal.z sign
	u16 tangent[2]{0,0};
};
